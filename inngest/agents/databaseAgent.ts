  ...
  parameters: z.object({
    ...
    items: z.array(
      z
        ...
        .describe(
          "An array of items on the receipt, including the name, quantity, unit price, and total price of each item.",
        ),
    ),
  }),
...
export const databaseAgent = createAgent({
  name: "Database Agent",
  description:
    "responsible for taking key information regarding receipt and saving it to the convex database",
  system:
